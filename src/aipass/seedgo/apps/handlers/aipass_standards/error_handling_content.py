...
def get_error_handling_standards() -> str:
    ...
    lines = [
        ...
        "  [dim]See: seedgo standards pack (error_handling)[/dim]",
        "  [dim]See: src/aipass/flow/apps/modules/ (working example)[/dim]",
        "  [dim]See: src/aipass/seedgo/apps/standards/aipass/modules/ (reference implementation)[/dim]",
        "",
