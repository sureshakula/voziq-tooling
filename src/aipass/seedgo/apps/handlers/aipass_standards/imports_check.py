...
def check_no_aipass_root(lines: List[str], file_path: str = "", bypass_rules: list | None = None) -> Dict:
    ...
    return {
        'name': 'No AIPASS_ROOT',
        'passed': True,
        'message': 'No AIPASS_ROOT usage (correct for pip packages)'
    }
...
def check_import_order(lines: List[str], file_path: str = "", bypass_rules: list | None = None) -> Optional[Dict]:
    ...
    stdlib_prefixes = (
        ...
        'import logging', 'import subprocess', 'import shutil', 'import copy',
        'import hashlib', 'import datetime', 'import tempfile', 'import ast',
        'import argparse', 'import importlib', 'import inspect', 'import unittest',
        'from pathlib', 'from typing', 'from datetime', 'from collections',
        'from functools', 'from dataclasses', 'from enum', 'from abc',
        'from io', 'from os', 'from contextlib',
    )
