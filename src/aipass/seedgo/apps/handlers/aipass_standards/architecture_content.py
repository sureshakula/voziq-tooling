...
def get_architecture_standards() -> str:
    ...
    lines = [
        ...
        "     [yellow]Rule:[/yellow] Each module implements [dim]handle_command(command, args)[/dim]",
        "     returning True if handled",
        ...
        "     [green]< 300:[/green] Perfect  [green]300-500:[/green] Good  [yellow]500-700:[/yellow] Heavy",
        "     [yellow]700-1500:[/yellow] Advisory (no dock)  [red]1500+:[/red] Must split",
        "",
        ...
        "  • Files 700-1500 lines = [yellow]advisory warning, consider splitting[/yellow] (no score dock)",
        "  • Files over 1500 lines = [red]must split — hard fail[/red]",
