"""Flow handlers package - Security protected."""
...
def _guard_branch_access():
    ...
    Only code from within the 'flow' branch can import these handlers.
    External branches must use flow.apps.modules instead.
    """
