...
_has_validate = hasattr(json_handler, "validate_json_structure")
_has_get_path = hasattr(json_handler, "get_json_path")
_has_ensure = hasattr(json_handler, "ensure_json_exists")
_has_load = hasattr(json_handler, "load_json")
_has_save = hasattr(json_handler, "save_json")

_skip_validate = pytest.mark.skipif(not _has_validate, reason="No validate_json_structure")
_skip_get_path = pytest.mark.skipif(not _has_get_path, reason="No get_json_path")
_skip_ensure = pytest.mark.skipif(not _has_ensure, reason="No ensure_json_exists")
_skip_load = pytest.mark.skipif(not _has_load, reason="No load_json")
