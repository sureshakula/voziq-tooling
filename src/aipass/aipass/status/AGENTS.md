<!-- Source: /home/patrick/Projects/AIPass/src/aipass/aipass/status/AGENTS.md -->
...
- **Registry** — `STATUS_REGISTRY.json` tracks all agents.
...
On startup, read: `STATUS_REGISTRY.json`, `README.md`, `STATUS.local.md`
