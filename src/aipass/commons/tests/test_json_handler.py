...
from aipass.commons.apps.handlers.json.json_handler import (
    _get_default,
...
import aipass.commons.apps.handlers.json.json_handler as json_handler_mod
...
def test_log_operation_appends_entry(tmp_path):
    ...
    from aipass.commons.apps.handlers.json.json_handler import log_operation
...
def test_ensure_module_jsons_creates_all_three(tmp_path):
    ...
    from aipass.commons.apps.handlers.json.json_handler import ensure_module_jsons
