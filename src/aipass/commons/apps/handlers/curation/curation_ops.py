...
def add_react(args: List[str]) -> dict:
    ...
    try:
        ...
        json_handler.log_operation(
            "add_reaction", {"reaction": reaction, "target_type": target_type, "target_id": target_id}
        )
...
def pin_post_cmd(args: List[str]) -> dict:
    ...
    try:
        ...
        post = conn.execute("SELECT id, author, title FROM posts WHERE id = ?", (post_id,)).fetchone()
