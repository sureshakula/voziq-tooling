...
def print_introspection():
    ...
    console.print(
        "Router and display layer for artifact workflows — crafting, listing, inspecting, collaborating, and signing."
    )
    console.print()
...
def _handle_sign(args: List[str]) -> bool:
    ...
    if result["completed"]:
        ...
        console.print()
        console.print(
            f"[green]Signed! {result['signer']} added signature to joint artifact {result['pending_id']}[/green]"
        )
