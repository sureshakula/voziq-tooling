...
def print_introspection():
    ...
    console.print(
        "Thin router for community digest workflows. Queries digest data and renders activity summaries with Rich."
    )
    console.print()
...
def _handle_digest(args: List[str]) -> bool:
    ...
    # Activity totals
    console.print(
        f"  [bold cyan]Activity:[/bold cyan] {totals['total_posts']} posts, {totals['total_comments']} comments"
    )
    console.print()
