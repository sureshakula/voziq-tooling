...
| `project-seed/` | The three-file on-ramp seeded into every project (via the GitLab project template): `/brain-memo` capture command, CLAUDE.md brain section, `BRAIN_REPO_PATH` convention. |
