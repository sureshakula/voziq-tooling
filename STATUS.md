...
- **Hook work (no dedicated DPLAN yet)** — spread across DPLAN-0093 (install hardening / hook path genericizing), DPLAN-0094/0095/0096 (multi-CLI hook integration research), DPLAN-0121 (AIPASS_HOME injection + local prompt hook wiring in aipass init), DPLAN-0125 Track A (Windows compat, hooks explicitly reserved for AIPass Developer session). Session 21 (2026-03-17) Patrick decided seedgo owns hooks — ownership declared, code still lives outside seedgo/apps/.
