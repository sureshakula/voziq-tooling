...
- **#270** — Compass devpulse personal layer scaffold (triple-layer gitignore, compass_wrapper.py stub, bypass entries)
...
- `compass_layer_design.md` — full 6-question design + initial seed strategy
